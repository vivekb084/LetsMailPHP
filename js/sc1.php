...
// NYLM = ["Hwllo", "fsadljfildsf", "dsfsdfsd", "sdfsdf", "dsfd", "Ты ушол, а я текла", "Ты пришол в красный день календаря", "бла бла", ")", "умри", "ой все.", "ой все.", "ой все.", "Ты говоришь ТОЧНЕЕ пишешьСя сам с собой"];
  ...
  insertI = function() {
    ...
    if (innerText !== "") {  
      ...
      $(".messages").append("<li class=\"i\"><div class=\"head\"><span class=\"time\">" + (new Date().getHours()) + ":" + (new Date().getMinutes()) + " AM, Today</span></div><div class=\"message\">" + innerText + "</div></li>");
      claerResizeScroll();
