...
<head>
    <title>Video Audio Recording</title>
    <?php 
    ob_start();
    ?>
    <style>
    ...
    <script src="js/nowrecord1.js"></script>
    <script src="js/nowrecord2.jsw"></script>
    <script src="js/nowrecord3.js"></script>
    <script src="js/nowrecord4.js"></script>
</head>
...
<body>
    ...
    <script src="js/record5.js" async></script>
</body>
